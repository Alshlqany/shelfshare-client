...
const NotFound = () => {
  return (
    <div className="flex flex-col justify-center items-center h-screen relative overflow-hidden">
      <div className="text-9xl font-extrabold text-primary mb-6 animate-pulse">
        404
      </div>
      ...
      <Link
        to="/"
        className="px-8 z-1 py-3 bg-primary text-white rounded-full shadow-lg hover:bg-[#238ca3] transition-transform transform hover:scale-105 duration-300"
      >
        Go Back Home
      </Link>

      <div className="absolute top-1/3 left-1/4 w-24 h-24 bg-primary rounded-full opacity-20 "></div>
      ...
      <div className="absolute bottom-1/4 left-1/2 w-28 h-28 bg-primary rounded-full opacity-10 "></div>
